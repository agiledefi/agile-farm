...
const AGLEXFARM = require("../artifacts/contracts/AgileFarm.sol/AgileFarm.json")

let AGLEXFARM_ADDRESS
let AGL_ADDRESS = "0xd57022d5cb065505093e2c4bbf7d683d2335ab6a"
...
async function deploy() {
  ...
  factory = new ethers.ContractFactory(AGLEXFARM.abi, AGLEXFARM.bytecode, walletWithProvider)
  ins = await factory.deploy(AGL_ADDRESS, deployer, "1000000000000000000", 9759275, 9859275, ETHER_SEND_CONFIG)
  await waitForMint(ins.deployTransaction.hash)
  AGLEXFARM_ADDRESS = ins.address
}
...
async function main() {
  ...
  await deploy()
  console.log(`
    AGLEXFARM_ADDRESS = ${AGLEXFARM_ADDRESS}
  `)
}
